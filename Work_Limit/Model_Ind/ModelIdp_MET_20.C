...
void limit() {
  ...
  //-----------------------
  //Float_t kf=1.5;
  Double_t  MD[6]  = {  3000  ,  3500  ,  4000  ,  4500  ,  5000, 5500};
  Double_t  dMD[6] = {19999., 19999., 19999., 19999., 19999. , 19999.};
  //char  *title[9]  = {"> 1000", "> 1500", "> 2000", "> 2500", "> 3000", "> 3500", "> 4000", "> 600"};
  TGraph    *axis  = new TGraph(6, MD, dMD);
  ...
  axis->GetYaxis()->SetRangeUser(0.000015,0.003);
  axis->GetYaxis()->SetMoreLogLabels(false);
  axis->GetXaxis()->SetRangeUser(3000.,5500.);
  ...
  Double_t med3000    = 1.02E-03;
  Double_t med3000_1D = 7.92E-04;
  Double_t med3000_1U = 1.32E-03;
  Double_t med3000_2D = 5.89E-04;
  Double_t med3000_2U = 1.67E-03;

  Double_t med3500    = 4.76E-04;
  Double_t med3500_1D = 3.54E-04;
  Double_t med3500_1U = 5.99E-04;
  Double_t med3500_2D = 2.91E-04;
  Double_t med3500_2U = 7.63E-04;

  Double_t med4000    = 1.97E-04;
  Double_t med4000_1D = 1.53E-04;
  Double_t med4000_1U = 2.57E-04;
  Double_t med4000_2D = 1.17E-04;
  Double_t med4000_2U = 3.31E-04;
 
  Double_t med4500    = 1.03E-04;
  Double_t med4500_1D = 7.97E-05;
  Double_t med4500_1U = 1.38E-04;
  Double_t med4500_2D = 6.17E-05;
  Double_t med4500_2U = 1.78E-04;
  
  Double_t med5000    = 5.19E-05;
  Double_t med5000_1D = 4.11E-05;
  Double_t med5000_1U = 6.91E-05;
  Double_t med5000_2D = 3.14E-05;
  Double_t med5000_2U = 9.06E-05;
...
*/
  ...
  text3 = new TLatex(3.570061,23.08044,"BG Uncertainity 20\% ");
  text3->SetNDC();
