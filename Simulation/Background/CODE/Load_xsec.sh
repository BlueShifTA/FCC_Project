...
HREF_B='http://faxbox.usatlas.org/group/hepsim/events/pp/100tev/wzjet_pythia8_ptbins/'
...
do 
    ...
    more x_sec_${FILENAME} | grep section | sed s:=:" ":g | awk '{print "'${pt[${i}]}'""_""'${pt[${i}+1]}'" " Cross Section : "$3" "$4" "$5" "$6}' >> X-sec_wzjet.txt 
