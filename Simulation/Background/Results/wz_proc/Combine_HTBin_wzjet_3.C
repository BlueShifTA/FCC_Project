...
void Combine_HTBin(){
   ...
   f[0]=new  TFile("tev100_wzjet_50_100_result_0_3.root");
   f[1]=new  TFile("tev100_wzjet_100_200_result_0_3.root");
   f[2]=new  TFile("tev100_wzjet_200_400_result_0_3.root");
   f[3]=new  TFile("tev100_wzjet_400_600_result_0_3.root");
   f[4]=new  TFile("tev100_wzjet_600_800_result_0_3.root");
   f[5]=new  TFile("tev100_wzjet_800_1000_result_0_3.root");
   f[6]=new  TFile("tev100_wzjet_1000_1500_result_0_3.root");
   f[7]=new  TFile("tev100_wzjet_1500_2000_result_0_3.root");
   f[8]=new  TFile("tev100_wzjet_2000_2500_result_0_3.root");
   f[9]=new  TFile("tev100_wzjet_2500_3000_result_0_3.root");
   f[10]=new TFile("tev100_wzjet_3000_4000_result_0_3.root");
   f[11]=new TFile("tev100_wzjet_4000_5000_result_0_3.root");
   f[12]=new TFile("tev100_wzjet_5000_10000_result_0_3.root");
   f[13]=new TFile("tev100_wzjet_10000_15000_result_0_3.root");
   f[14]=new TFile("tev100_wzjet_15000_20000_result_0_3.root");
   f[15]=new TFile("tev100_wzjet_20000_25000_result_0_3.root");
   ...
   for (Int_t i = 0 ; i < 16 ; i ++ ) {   // index for Selection Cut   
       ...
       for (Int_t i_main = 0 ;i_main<16;i_main++ ) {   // index for open each file
         ...
         factor = NormLumi*xsecwzonlyjet[i_main]*1000.f/Entry[i_main]->GetEntries();//GetSumOfWeights();
         cout << "Number: " << i_main << " xsec: " << xsecwzonlyjet[i_main] << " factor: " << factor << " Entry: " << Entry[i_main]->GetEntries() << endl;
       ...
       leg->SetHeader("#splitline{#sqrt{s} = 100 TeV, #int L dt = 1 fb^{-1}}{W^{#pm}/Z^{0}}");
