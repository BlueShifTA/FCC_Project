# FCC proposed detector. Sep. 2015 
# taus reconstruction is removed to deal with input slimmed records
# based on  Delphes 3.3 (Oct. 2015)  
# Originally created by Heather Gray and Filip Moortgat 
# for FCC detector studies 
# Other changes:
# Oct. 1. 2015: 
#      Modified for HepSim by S.Chekanov (ANL)
#      Also enabling jet substructure (jet type 7)
#      Tau reconstruction is removed for 
#      HepSim slimmed samples
#
# Oct 16, 2015: 
#      Corrected btagging by Michele Selvaggi 
############################################################
