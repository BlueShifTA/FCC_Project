...
void Combine_HTBin(){
   ...
   f[0]=new  TFile("tev100_ttbar_50_100_result.root");
   f[1]=new  TFile("tev100_ttbar_100_200_result.root");
   f[2]=new  TFile("tev100_ttbar_200_400_result.root");
   f[3]=new  TFile("tev100_ttbar_400_600_result.root");
   f[4]=new  TFile("tev100_ttbar_600_800_result.root");
   f[5]=new  TFile("tev100_ttbar_800_1000_result.root");
   f[6]=new  TFile("tev100_ttbar_1000_1500_result.root");
   f[7]=new  TFile("tev100_ttbar_1500_2000_result.root");
   f[8]=new  TFile("tev100_ttbar_2000_2500_result.root");
   f[9]=new  TFile("tev100_ttbar_2500_3000_result.root");
   f[10]=new TFile("tev100_ttbar_3000_4000_result.root");
   f[11]=new TFile("tev100_ttbar_4000_5000_result.root");
   f[12]=new TFile("tev100_ttbar_5000_10000_result.root");
   f[13]=new TFile("tev100_ttbar_10000_15000_result.root");
   f[14]=new TFile("tev100_ttbar_15000_20000_result.root");
   f[15]=new TFile("tev100_ttbar_20000_25000_result.root");
   ...
   for (Int_t i = 0 ; i < 16 ; i ++ ) {   // index for Selection Cut   
       ...
       for (Int_t i_main = 0 ;i_main<16;i_main++ ) {   // index for open each file
         ...
         factor = NormLumi*xsecttbar[i_main]*1000.f/Entry[i_main]->GetEntries();//GetSumOfWeights();
         cout << "Number: " << i_main << " xsec: " << xsecttbar[i_main] << " factor: " << factor << " Entry: " << Entry[i_main]->GetEntries() << endl;
